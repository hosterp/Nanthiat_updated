...
class CustomerInvoiceFollowUp(models.Model):
	...
	bill_amount = fields.Float('Bill Amount',compute='compute_bill_amount')
	district = fields.Char('District',store=True)
	department = fields.Char('Department')
	contractor_id = fields.Many2one('res.company.new','Contractor',store=True)
	...
	# ,related="project_id.contractor_id"
